// Generated by TKG at 2016-01-25 15:03:56
...
const uint8_t keymaps[][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
    ...
    [0] = KEYMAP_TKG(
        ...
        LALT,LCTL,LGUI,          SPC,                     RGUI,RCTL,FN0, BSLS),
    [1] = KEYMAP_TKG(
        TRNS,F1,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9,  F10, F11, F12, NO,   \
        TAB, Q,   W,   E,   R,   T,   Y,   U,   I,   O,   P,   LBRC,RBRC,BSPC, \
        CAPS,VOLU,VOLD,MUTE,F,   G,   H,   J,   K,   L,   SCLN,QUOT,     ENT,  \
        LSFT,     FN1, FN2, FN3, FN4, B,   N,   M,   COMM,DOT, SLSH,     LSFT, \
        LALT,LCTL,LGUI,          TRNS,                    RGUI,RCTL,FN0, BSLS),
