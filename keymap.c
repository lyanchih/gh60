// Generated by TKG at 2016-01-30 10:54:08
...
#define KEYMAP_TKG( \
    ...
    K4A, K4B, K4C,           K4F,                K4J, K4K, K4L, K4M       \
) { \
    ...
    { KC_##K4A, KC_##K4B, KC_##K4C, KC_NO,    KC_NO,    KC_##K4F, KC_NO,    KC_NO,    KC_NO,    KC_##K4J, KC_##K4K, KC_##K4L, KC_##K4M, KC_NO    }  \
}
...
const uint8_t keymaps[][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
    ...
    [0] = KEYMAP_TKG(
        ...
        LALT,LCTL,LGUI,          SPC,                GRV, RGUI,RCTL,RALT),
    [1] = KEYMAP_TKG(
        TRNS,F1,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9,  F10, F11, F12, NO,   \
        TAB, Q,   W,   E,   R,   T,   Y,   U,   I,   O,   P,   LBRC,RBRC,BSPC, \
        CAPS,VOLU,VOLD,MUTE,F,   G,   H,   J,   K,   L,   SCLN,QUOT,     ENT,  \
        LSFT,     FN1, FN2, FN3, FN4, B,   N,   M,   COMM,DOT, SLSH,FN0, LSFT, \
        LALT,LCTL,LGUI,          SPC,                NO,  RGUI,RCTL,RALT),
